...
void setup() {
  ...
  peerInfo.peer_addr[0] = 0xa4;
  peerInfo.peer_addr[1] = 0xe5;
  peerInfo.peer_addr[2] = 0x7c;
  peerInfo.peer_addr[3] = 0xf6;
  peerInfo.peer_addr[4] = 0x6e;
  peerInfo.peer_addr[5] = 0x1c;
